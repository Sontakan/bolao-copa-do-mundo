...
export class UIRenderer {
  ...
  _normalizeTeamName(name) {
    ...
    const map = {
      ...
      'República Tcheca': 'Czechia', 'Republica Tcheca': 'Czechia',
      'Bósnia': 'Bosnia-Herzegovina', 'Bosnia': 'Bosnia-Herzegovina',
      'Estados Unidos': 'United States',
      'Suíça': 'Switzerland', 'Suica': 'Switzerland',
      'Escócia': 'Scotland', 'Escocia': 'Scotland',
      ...
      'Tunísia': 'Tunisia', 'Tunisia': 'Tunisia',
      'Espanha': 'Spain',
      ...
      'Noruega': 'Norway',
      'Argentina': 'Argentina',
      'Argélia': 'Algeria', 'Argelia': 'Algeria',
      'Áustria': 'Austria', 'Austria': 'Austria',
      'Jordânia': 'Jordan', 'Jordania': 'Jordan',
      'Portugal': 'Portugal',
      'RD Congo': 'Congo DR',
      'Inglaterra': 'England',
      ...
      'Uzbequistão': 'Uzbekistan', 'Uzbequistao': 'Uzbekistan',
